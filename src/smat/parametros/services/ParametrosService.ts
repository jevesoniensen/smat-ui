...
export class ParametrosService {
  ...
  async getRamosAtividade(): Promise<Models.RamoAtividade[]> {
    try {
      return await this.apiService.get<Models.RamoAtividade[]>(`${this.BASE_URL_EMPRESAS}/ramosatividade`);
    } catch (error) {
  ...
  async createRamoAtividade(data: Partial<Models.RamoAtividade>): Promise<Models.RamoAtividade> {
    try {
      return await this.apiService.post<Models.RamoAtividade>(`${this.BASE_URL_EMPRESAS}/ramosatividade`, data);
    } catch (error) {
  ...
  async updateRamoAtividade(id: string | number, data: Partial<Models.RamoAtividade>): Promise<Models.RamoAtividade> {
    try {
      return await this.apiService.put<Models.RamoAtividade>(`${this.BASE_URL_EMPRESAS}/ramosatividade/${id}`, data);
    } catch (error) {
  ...
  async deleteRamoAtividade(id: string | number): Promise<void> {
    try {
      await this.apiService.delete(`${this.BASE_URL_EMPRESAS}/ramosatividade/${id}`);
    } catch (error) {
  ...
  async getAgentesCausadores(): Promise<Models.AgenteCausador[]> {
    try {
      return await this.apiService.get<Models.AgenteCausador[]>(`${this.BASE_URL}/agentes-causadores`);
    } catch (error) {
  ...
  async createAgenteCausador(data: Partial<Models.AgenteCausador>): Promise<Models.AgenteCausador> {
    try {
      return await this.apiService.post<Models.AgenteCausador>(`${this.BASE_URL}/agentes-causadores`, data);
    } catch (error) {
  ...
  async updateAgenteCausador(id: string | number, data: Partial<Models.AgenteCausador>): Promise<Models.AgenteCausador> {
    try {
      return await this.apiService.put<Models.AgenteCausador>(`${this.BASE_URL}/agentes-causadores/${id}`, data);
    } catch (error) {
  ...
  async deleteAgenteCausador(id: string | number): Promise<void> {
    try {
      await this.apiService.delete(`${this.BASE_URL}/agentes-causadores/${id}`);
    } catch (error) {
  ...
  async getLocaisLesao(): Promise<Models.LocalLesao[]> {
    try {
      return await this.apiService.get<Models.LocalLesao[]>(`${this.BASE_URL}/locais-lesao`);
    } catch (error) {
  ...
  async createLocalLesao(data: Partial<Models.LocalLesao>): Promise<Models.LocalLesao> {
    try {
      return await this.apiService.post<Models.LocalLesao>(`${this.BASE_URL}/locais-lesao`, data);
    } catch (error) {
  ...
  async updateLocalLesao(id: string | number, data: Partial<Models.LocalLesao>): Promise<Models.LocalLesao> {
    try {
      return await this.apiService.put<Models.LocalLesao>(`${this.BASE_URL}/locais-lesao/${id}`, data);
    } catch (error) {
  ...
  async deleteLocalLesao(id: string | number): Promise<void> {
    try {
      await this.apiService.delete(`${this.BASE_URL}/locais-lesao/${id}`);
    } catch (error) {
  ...
  async getLocaisAtendimento(): Promise<Models.LocalAtendimento[]> {
    try {
      return await this.apiService.get<Models.LocalAtendimento[]>(`${this.BASE_URL}/locais-atendimento`);
    } catch (error) {
  ...
  async createLocalAtendimento(data: Partial<Models.LocalAtendimento>): Promise<Models.LocalAtendimento> {
    try {
      return await this.apiService.post<Models.LocalAtendimento>(`${this.BASE_URL}/locais-atendimento`, data);
    } catch (error) {
  ...
  async updateLocalAtendimento(id: string | number, data: Partial<Models.LocalAtendimento>): Promise<Models.LocalAtendimento> {
    try {
      return await this.apiService.put<Models.LocalAtendimento>(`${this.BASE_URL}/locais-atendimento/${id}`, data);
    } catch (error) {
  ...
  async deleteLocalAtendimento(id: string | number): Promise<void> {
    try {
      await this.apiService.delete(`${this.BASE_URL}/locais-atendimento/${id}`);
    } catch (error) {
  ...
  async getItensFiscalizacao(): Promise<Models.ItemFiscalizacao[]> {
    try {
      return await this.apiService.get<Models.ItemFiscalizacao[]>(`${this.BASE_URL}/itens-fiscalizacao`);
    } catch (error) {
  ...
  async createItemFiscalizacao(data: Partial<Models.ItemFiscalizacao>): Promise<Models.ItemFiscalizacao> {
    try {
      return await this.apiService.post<Models.ItemFiscalizacao>(`${this.BASE_URL}/itens-fiscalizacao`, data);
    } catch (error) {
  ...
  async updateItemFiscalizacao(id: string | number, data: Partial<Models.ItemFiscalizacao>): Promise<Models.ItemFiscalizacao> {
    try {
      return await this.apiService.put<Models.ItemFiscalizacao>(`${this.BASE_URL}/itens-fiscalizacao/${id}`, data);
    } catch (error) {
  ...
  async deleteItemFiscalizacao(id: string | number): Promise<void> {
    try {
      await this.apiService.delete(`${this.BASE_URL}/itens-fiscalizacao/${id}`);
    } catch (error) {
  ...
  async getPontosFiscalizacao(): Promise<Models.PontoFiscalizacao[]> {
    try {
      return await this.apiService.get<Models.PontoFiscalizacao[]>(`${this.BASE_URL}/pontos-fiscalizacao`);
    } catch (error) {
  ...
  async createPontoFiscalizacao(data: Partial<Models.PontoFiscalizacao>): Promise<Models.PontoFiscalizacao> {
    try {
      return await this.apiService.post<Models.PontoFiscalizacao>(`${this.BASE_URL}/pontos-fiscalizacao`, data);
    } catch (error) {
  ...
  async updatePontoFiscalizacao(id: string | number, data: Partial<Models.PontoFiscalizacao>): Promise<Models.PontoFiscalizacao> {
    try {
      return await this.apiService.put<Models.PontoFiscalizacao>(`${this.BASE_URL}/pontos-fiscalizacao/${id}`, data);
    } catch (error) {
  ...
  async deletePontoFiscalizacao(id: string | number): Promise<void> {
    try {
      await this.apiService.delete(`${this.BASE_URL}/pontos-fiscalizacao/${id}`);
    } catch (error) {
  ...
  async getVinculosItemPonto(pontoId: string | number): Promise<Models.ItemFiscalizacao[]> {
    try {
      return await this.apiService.get<Models.ItemFiscalizacao[]>(`${this.BASE_URL}/pontos-fiscalizacao/${pontoId}/items`);
    } catch (error) {
  ...
  async updateVinculoItemPonto(pontoId: string | number, itemIds: (string | number)[]): Promise<any> {
    try {
      return await this.apiService.post(`${this.BASE_URL}/pontos-fiscalizacao/${pontoId}/items`, { itemIds });
    } catch (error) {
  ...
  async getRegionais(): Promise<Models.Regional[]> {
    try {
      return await this.apiService.get<Models.Regional[]>(`${this.BASE_URL}/regionais`);
    } catch (error) {
  ...
  async createRegional(data: Partial<Models.Regional>): Promise<Models.Regional> {
    try {
      return await this.apiService.post<Models.Regional>(`${this.BASE_URL}/regionais`, data);
    } catch (error) {
  ...
  async updateRegional(id: string | number, data: Partial<Models.Regional>): Promise<Models.Regional> {
    try {
      return await this.apiService.put<Models.Regional>(`${this.BASE_URL}/regionais/${id}`, data);
    } catch (error) {
  ...
  async deleteRegional(id: string | number): Promise<void> {
    try {
      await this.apiService.delete(`${this.BASE_URL}/regionais/${id}`);
    } catch (error) {
  ...
  async getTelefonesRegional(regionalId: string | number): Promise<Models.TelefoneRegional[]> {
    try {
      return await this.apiService.get<Models.TelefoneRegional[]>(`${this.BASE_URL}/regionais/${regionalId}/telefones`);
    } catch (error) {
  ...
  async addTelefoneRegional(regionalId: string | number, data: Partial<Models.TelefoneRegional>): Promise<Models.TelefoneRegional> {
    try {
      return await this.apiService.post<Models.TelefoneRegional>(`${this.BASE_URL}/regionais/${regionalId}/telefones`, data);
    } catch (error) {
  ...
  async deleteTelefoneRegional(regionalId: string | number, telefoneId: string | number): Promise<void> {
    try {
      await this.apiService.delete(`${this.BASE_URL}/regionais/${regionalId}/telefones/${telefoneId}`);
    } catch (error) {
  ...
  async getTiposAcidente(): Promise<Models.TipoAcidente[]> {
    return this.apiService.get<Models.TipoAcidente[]>(`${this.BASE_URL}/tipos-acidente`, { _: Date.now() });
  }
  async getTiposEmpregador(): Promise<Models.TipoEmpregador[]> {
    return this.apiService.get<Models.TipoEmpregador[]>(`${this.BASE_URL_EMPRESAS}/tiposempregadores`, { _: Date.now() });
  }
  async getTiposDepoimento(): Promise<Models.TipoDepoimento[]> {
    return this.apiService.get<Models.TipoDepoimento[]>(`${this.BASE_URL}/tipos-depoimento`, { _: Date.now() });
  }
  async getEstados(): Promise<Models.Estado[]> {
    return this.apiService.get<Models.Estado[]>(`${this.BASE_URL}/estados`, { _: Date.now() });
  }
  async getMunicipios(estadoId?: string | number): Promise<Models.Municipio[]> {
    ...
    return this.apiService.get<Models.Municipio[]>(`${this.BASE_URL}/municipios`, params);
  }
  async getOcupacoes(): Promise<Models.Ocupacao[]> {
    return this.apiService.get<Models.Ocupacao[]>(`${this.BASE_URL}/ocupacoes`, { _: Date.now() });
  }
  async getStatus(): Promise<Models.Status[]> {
    return this.apiService.get<Models.Status[]>(`${this.BASE_URL}/status`, { _: Date.now() });
  }
  async getTiposMedidaCorretiva(): Promise<Models.TipoMedidaCorretiva[]> {
    return this.apiService.get<Models.TipoMedidaCorretiva[]>(`${this.BASE_URL}/tipos-medida-corretiva`, { _: Date.now() });
  }
  async getRegionaisByEstado(estadoId: string | number): Promise<Models.Regional[]> {
    return this.apiService.get<Models.Regional[]>(`${this.BASE_URL}/regionais`, { estado: estadoId, _: Date.now() });
  }
}
