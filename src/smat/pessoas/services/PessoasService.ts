...
export class PessoasService {
  ...
  async createTrabalhador(data: Partial<Models.Trabalhador>): Promise<Models.Trabalhador> {
    try {
      return await this.apiService.post<Models.Trabalhador>(`${this.BASE_URL}/trabalhadores`, data);
    } catch (error) {
  ...
  async updateTrabalhador(id: string, data: Partial<Models.Trabalhador>): Promise<Models.Trabalhador> {
    try {
      return await this.apiService.put<Models.Trabalhador>(`${this.BASE_URL}/trabalhadores/${id}`, data);
    } catch (error) {
  ...
  async getTrabalhador(id: string | number): Promise<Models.Trabalhador> {
    try {
      return await this.apiService.get<Models.Trabalhador>(`${this.BASE_URL}/trabalhadores/${id}`);
    } catch (error) {
  ...
  async listTrabalhadores(): Promise<Models.Trabalhador[]> {
    try {
      return await this.apiService.get<Models.Trabalhador[]>(`${this.BASE_URL}/trabalhadores`);
    } catch (error) {
  ...
  async deleteTrabalhador(id: string): Promise<void> {
    try {
      await this.apiService.delete(`${this.BASE_URL}/trabalhadores/${id}`);
    } catch (error) {
  ...
  async createTestemunha(data: Partial<Models.Testemunha>): Promise<Models.Testemunha> {
    try {
      return await this.apiService.post<Models.Testemunha>(`${this.BASE_URL}/testemunhas`, data);
    } catch (error) {
  ...
  async updateTestemunha(id: string, data: Partial<Models.Testemunha>): Promise<Models.Testemunha> {
    try {
      return await this.apiService.put<Models.Testemunha>(`${this.BASE_URL}/testemunhas/${id}`, data);
    } catch (error) {
  ...
  async getTestemunha(id: string | number): Promise<Models.Testemunha> {
    try {
      return await this.apiService.get<Models.Testemunha>(`${this.BASE_URL}/testemunhas/${id}`);
    } catch (error) {
  ...
  async listTestemunhas(): Promise<Models.Testemunha[]> {
    try {
      return await this.apiService.get<Models.Testemunha[]>(`${this.BASE_URL}/testemunhas`);
    } catch (error) {
  ...
  async deleteTestemunha(id: string): Promise<void> {
    try {
      await this.apiService.delete(`${this.BASE_URL}/testemunhas/${id}`);
    } catch (error) {
  ...
  async createAgenteSaude(data: Partial<Models.AgenteSaude>): Promise<Models.AgenteSaude> {
    try {
      return await this.apiService.post<Models.AgenteSaude>(`${this.BASE_URL}/agentes-saude`, data);
    } catch (error) {
  ...
  async updateAgenteSaude(id: string, data: Partial<Models.AgenteSaude>): Promise<Models.AgenteSaude> {
    try {
      return await this.apiService.put<Models.AgenteSaude>(`${this.BASE_URL}/agentes-saude/${id}`, data);
    } catch (error) {
  ...
  async getAgenteSaude(id: string | number): Promise<Models.AgenteSaude> {
    try {
      return await this.apiService.get<Models.AgenteSaude>(`${this.BASE_URL}/agentes-saude/${id}`);
    } catch (error) {
  ...
  async listAgentesSaude(): Promise<Models.AgenteSaude[]> {
    try {
      return await this.apiService.get<Models.AgenteSaude[]>(`${this.BASE_URL}/agentes-saude`);
    } catch (error) {
  ...
  async deleteAgenteSaude(id: string): Promise<void> {
    try {
      await this.apiService.delete(`${this.BASE_URL}/agentes-saude/${id}`);
    } catch (error) {
  ...
  async createRepresentante(data: Partial<Models.RepresentanteEmpresa>): Promise<Models.RepresentanteEmpresa> {
    try {
      return await this.apiService.post<Models.RepresentanteEmpresa>(`${this.BASE_URL}/representantes`, data);
    } catch (error) {
  ...
  async updateRepresentante(id: string, data: Partial<Models.RepresentanteEmpresa>): Promise<Models.RepresentanteEmpresa> {
    try {
      return await this.apiService.put<Models.RepresentanteEmpresa>(`${this.BASE_URL}/representantes/${id}`, data);
    } catch (error) {
  ...
  async listRepresentantes(empregadorId?: string): Promise<Models.RepresentanteEmpresa[]> {
    try {
      ...
      return await this.apiService.get<Models.RepresentanteEmpresa[]>(`${this.BASE_URL}/representantes${query}`);
    } catch (error) {
  ...
  async deleteRepresentante(id: string): Promise<void> {
    try {
      await this.apiService.delete(`${this.BASE_URL}/representantes/${id}`);
    } catch (error) {
  ...
  async searchPessoas(term: string, tipoDepoimentoId?: string): Promise<Models.Pessoa[]> {
    try {
      ...
      return await this.apiService.get<Models.Pessoa[]>(`${this.BASE_URL}/search${queryStr}`);
    } catch (error) {
