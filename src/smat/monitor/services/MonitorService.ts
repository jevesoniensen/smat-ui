...
export class MonitorService {
  ...
  async getDashboardData(): Promise<any> {
    try {
      return await this.apiService.get(`${this.BASE_URL}/dashboard`);
    } catch (error) {
  ...
  async getStatistics(period: string = 'month'): Promise<any> {
    try {
      return await this.apiService.get(`${this.BASE_URL}/statistics?period=${period}`);
    } catch (error) {
  ...
  async getRecentAcidentes(limit: number = 10): Promise<Models.Acidente[]> {
    try {
      return await this.apiService.get<Models.Acidente[]>(`${this.BASE_URL}/recent-accidents?limit=${limit}`);
    } catch (error) {
  ...
  async getPendingInspections(): Promise<Models.Fiscalizacao[]> {
    try {
      return await this.apiService.get<Models.Fiscalizacao[]>(`${this.BASE_URL}/pending-inspections`);
    } catch (error) {
  ...
  async getAlerts(): Promise<any[]> {
    try {
      return await this.apiService.get<any[]>(`${this.BASE_URL}/alerts`);
    } catch (error) {
  ...
  async listMonitores(): Promise<Models.Monitor[]> {
    try {
      return await this.apiService.get<Models.Monitor[]>(`${this.BASE_URL}/list`);
    } catch (error) {
  ...
  async createMonitor(data: Partial<Models.Monitor>): Promise<Models.Monitor> {
    try {
      return await this.apiService.post<Models.Monitor>(`${this.BASE_URL}/create`, data);
    } catch (error) {
  ...
  async updateMonitor(id: string | number, data: Partial<Models.Monitor>): Promise<Models.Monitor> {
    try {
      return await this.apiService.put<Models.Monitor>(`${this.BASE_URL}/${id}`, data);
    } catch (error) {
  ...
  async getCampos(): Promise<any[]> {
    try {
      return await this.apiService.get<any[]>(`${this.BASE_URL}/campos`);
    } catch (error) {
  ...
  async getQueryCampos(campoId: string | number): Promise<any[]> {
    try {
      return await this.apiService.get<any[]>(`${this.BASE_URL}/querycampos?campo=${campoId}`);
    } catch (error) {
